...
public class BelizeFGC2023 extends LinearOpMode {
    ...
    private double speedMultiplier = 1.0; // Default speed multiplier
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Speed Multiplier", speedMultiplier); // Display the current speed multiplier
            telemetry.update();
            ...
            // Apply the selected speed multiplier to the drive power
            ...
            //Lift Control
            rightliftpower = Range.clip(-gamepad2.left_stick_y, -0.5, 0.5);
            leftliftpower = Range.clip(-gamepad2.left_stick_y, -0.5, 0.5);
            ...
            if (gamepad2.circle) {
                ...
                belFGC2023.LeftIntake.setPower(0);
            }

            // Adjust speed multiplier based on gamepad1 button presses
            if (gamepad1.cross) {
                speedMultiplier = 1.0; // Highest speed multiplier
            } else if (gamepad1.circle) {
                speedMultiplier = 0.5; // Mid speed multiplier
            } else if (gamepad1.square) {
                speedMultiplier = 0.25; // Slowest speed multiplier
            }
